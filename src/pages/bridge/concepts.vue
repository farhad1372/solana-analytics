  ...
  <div class="row">
    ...
    <img class="rounded" src="@/assets/images/bridge.png" style="width: 100%" />
      ...
      <p>
        ...
        the tokens that are used to create the <br />
